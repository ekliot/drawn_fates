...
(function() {
  ...
  var Card, Cloth, app, array_get, load_deck, shuffle, sleep;
  ...
  load_deck = function() {
    var card, cards_asher, cards_cedrick, cards_gustave, deck, flipped, k, l, len, len1, len2, m, sample, sample_size, to_flip;
    deck = [];
    // ==================================================================================================
    // SAMPLE CARD FORMAT
    ...
    cards_asher = [ // ACT 1
      {
        ...
        date_def: new Date(2013,
      8,
      9,
      17,
      32),
        text_def: ["Can't believe I'm saying this, but I'm glad I didn't blow off that first math class of freshman year. I didn't give a shit... I mean, I still don't, but I especially didn't back then.",
      ...
      14),
        text_rev: [
          ...
          "Is he getting stoned before every one of his classes?" // ACT 2
        ]
      },
      {
      ...
      17,
      32),
        text_def: ["I still surprise myself how good this gig I've got going is.",
      ...
      14),
        text_rev: [
          ...
          "Whatever, man, I got away from all that middle school drama for a reason, I don't want to get in the middle of whatever shitstorm comes out of that sewing circle." // ACT 3
        ]
      },
      {
      ...
      17,
      32),
        text_def: ["Shit, am I an awful person?",
      ...
      14),
        text_rev: [
          ...
          "No, I can't let myself think those things. Survival of the fittest and all that, I'm not losing face or letting my grades slip to help his dumb ass up." // ACT 4
        ]
      },
      {
      ...
      30),
        text_rev: [
          ...
          "The two have nothing in common, she\'s not even in any of his classes. And he was just so damn skittish... " // ACT 5
        ]
      },
      {
      ...
      12,
      20),
        text_def: ["Reuven really weirded me out the other day -- I know, he\'s already pretty weird, but what was that whole scene about this coin about?",
      ...
      30),
        text_rev: [
          ...
          "Barring the scratched out eyes, that king looks just like this coin. But these kinds of portraits are never exact, right? They could easily just look alike, and this coin is so old..." // ACT 6
        ]
      },
      {
      ...
      14,
      20),
        text_def: ["Man, that goddamn worm, he had the <i>fucking gall</i> to steal that coin. I <i>promised Reuven</i> I\'d keep it safe.",
      ...
      20),
        text_rev: [
          ...
          "Actually, wait a sec, why does Rose keep showing up everywhere I look all of a sudden? Is this that fixation thing they were talking about in psych, or is she actually invading my life?" // ACT 7
        ]
      },
      {
      ...
      20),
        text_rev: [
          ...
          "I could die.",
          "It\'s a gamble I\'m willing to take, not like there\'s anybody around anymore to give a shit." // ACT 8
        ]
      },
      {
      ...
      19,
      20),
        text_def: ["It\'s going to happen. We\'re gonna clean this up, we\'ll save the world and nobody will even know what happened. I hate to say this, but this feels just like a comic book.",
      ...
      20),
        text_rev: [
          ...
          "I hope Reuven is proud of me, wherever he is." // ACT 9
        ]
      },
      {
      ...
      16,
      20),
        text_def: ["Gus and Cedrick and I are… A squad now, I guess. We\'re stronger now, somehow. Changed for the better, as fucked up as that sounds.",
      ...
      16,
      20),
        text_rev: ["This life won\'t feel normal. Not for some time. Everything\'s different now.",
    ...
    cards_cedrick = [ // ACT 1
      ...
      17,
      32),
        text_def: ["Tomorrow I\'ll be starting the next year of high school. As I write this, I am filled with an anxious eagerness. I\'ve tried so hard to change my attitude this summer, really, and I hope that I have become less callous. With any luck they will have changed too. I fear that my disdain for the peers I will have to spend the next four years with was justified. Maybe Gustave and I can still be friends."],
        date_rev: new Date(2013,
      8,
      8,
      21,
      14),
        text_rev: ["I\'ve thought a lot about school over this summer. I am a corpse; tomorrow I must return to the grave. My peers\' sadistic immaturity knows no bounds, and I fear it will only grow worse this year. Our school system breeds malicious behavior and conformity. I must hold fast my sanity and individualism."] // ACT 2
      },
      {
        img: "media/cards/judgement.png",
        date_def: new Date(2013,
      ...
      10,
      16,
      20), // the order goes: year, month (0-indexed), day, hour (24h), minute
        text_def: ["I was wrong about Gustave... He\'s become one of <i>them</i>: a cocky musclehead jock. They way he looks at me now, like I\'m some pathetic piece of shit, makes me glad we\'re no longer friends.",
      ...
      20),
        text_rev: [
          ...
          "I\'m not really good at anything in particular. All I do is skulk around and mope." // ACT 3
        ]
      },
      {
        img: "media/cards/hierophant.png",
      ...
      16,
      20), // the order goes: year, month (0-indexed), day, hour (24h), minute
        text_def: ["I\'m going to do it tomorrow after math class. When Rose is alone at her locker, I\'ll ask her out. I don\'t know what I\'ll do if she says no. I mean, she <i>has</i> to say yes. I\'m terrified of the rumors that\'ll for sure spread if she says no. It would plague my existence for the rest of high school.",
      ...
      20),
        text_rev: [
          ...
          "\"Why don\'t you go for someone your own speed?\" He said. \"You know, like a snail?\" His cackling hyena friends all high-fived him. Mocking me makes them feel better about their own miserable lives. They feed off malice and perverse admiration." // ACT 4
        ]
      },
      {
        img: "media/cards/world.png",
      ...
      20),
        text_rev: [
          ...
          "Asher and Gustave are up to something, I know it. I saw them sneaking around into Ruven\'s office when he wasn\'t there, and they won\'t stop talking about a coin or something. It has something to do with that math teacher." // ACT 5
        ]
      },
      {
        img: "media/cards/wheel.png",
      ...
      17,
      32),
        text_def: ["Man, am I lucky or what? The unbelievable happened today: Rose asked me out! At first I stood there like a dunce before finally blurting out \"yeah, sure.\" God I\'m such a dweeb sometimes. She\'s probably already regretting it, I\'ll soon be dumped I\'m sure.",
      ...
      21,
      14),
        text_rev: ["Gustave\'s dad died today, and as much as I hate his guts, I feel really bad for the guy. He seems really shook up about it, like in a weird way though. He and Asher have been inseparable lately, but I haven\'t seen him today. I wonder what they\'re up to, it can\'t be anything good. I just hope it doesn\'t involve me somehow."] // ACT 6
      },
      {
        img: "media/cards/devil.png",
        date_def: new Date(2013,
      ...
      17,
      32),
        text_def: ["Man, I\'d do anything for Rose. She asked me to steal some coin from Asher, Gustave\'s new brown nosing best friend. I\'ve seen them being all buddy-buddy in the hall. <i>Like I need an excuse to mess with them</i>.",
      ...
      14),
        text_rev: [
          ...
          "Anyways, I didn\'t have the coin on me but Gustave shoved me into a locker and roughed me up trying to find it. It must be valuable or something. Rose hasn\'t mentioned it since she asked me to steal it." // ACT 7
        ]
      },
      {
        img: "media/cards/moon.png",
      ...
      20),
        text_rev: [
          ...
          "\"Leave me and Rose alone, assholes\" I told them, wanting them to just go away, but they wouldn\'t leave. They insisted I listened to what they had to say: that Rose is really a demon of fate, that she was summoned by our math teacher, and that only we could stop her. They\'ve put a commendable amount of effort into this prank." // ACT 8
        ]
      },
      {
        img: "media/cards/death.png",
      ...
      16,
      20), // the order goes: year, month (0-indexed), day, hour (24h), minute
        text_def: ["It\'s been awhile since I wrote in here... Gustave is cool now, it\'s like it used to be. We still hang out with Asher too. Part of me misses Rose. Even though she was some kind of horrible demon, those few days when we were dating were a twister of elation. I feel bad for her parents, but they can never know the truth."],
        date_rev: new Date(2013,
      11,
      19,
      16,
      20),
        text_rev: ["It\'s been awhile since I wrote in here... It\'s been hard to move on. Knowing what we know, you just want to blurt it out all the time. Even if we did no one would believe us. It sounds so insane even thinking about it, like a nightmare. Rose\'s parents will never know what happened to her."]
      }
    ];
    cards_gustave = [ // ACT 1
      {
      ...
      17,
      32),
        text_def: ["I am absolutely terrified of starting school this year. I mean it can\'t be that different from other years of school. I go to class, goof off a bit with my friends, have a big lunch, sleep during the rest of my classes, and hit the batting cages.",
      ...
      14),
        text_rev: [
          ...
          "Besides... It is really haunting to see Cedrick there all the time. We used to play together constantly. The Iceman to my Goose, ya know? Now it just doesn't feel right." // ACT 2
        ]
      },
      {
        img: "media/cards/fool.png",
      ...
      17,
      32),
        text_def: ["Despite my initial hesitations I had to be positive. This really felt like a time for me to reinvent myself, ya know. If I want to make the baseball team I better start practicing from now. The guys on the squad can\'t know I used to hang out with that weirdo Cedrick. I mean we used to be friends when we were kids, but he is really not into sports or anything at all. Gotta keep up with the popular kids if I want to stay on top, you feel."],
        date_rev: new Date(2013,
      8,
      20,
      21,
      14),
        text_rev: [
          ...
          "Asher isn\'t really my kind of guy to chill with but his dealer sells him the best kush in the state." // ACT 3
        ]
      },
      {
        img: "media/cards/judgement.png",
      ...
      17,
      32),
        text_def: ["The end justifies the means right?",
      ...
      14),
        text_rev: [
          ...
          "He always had a knack for traps when we were kids..." // ACT 4
        ]
      },
      {
        img: "media/cards/hierophant.png",
      ...
      17,
      32),
        text_def: ["So I went to Ashers house today after practice because these trig identities have me all kinds of fucked up. He keeps talking about Soh-Cah-Toa or whatever. I don\'t know what some old dead Greek philosopher has to do with math.",
      ...
      14),
        text_rev: [
          ...
          "What even is Asher\'s relationship with the math teacher anyway? It\'s inappropriate." // ACT 5
        ]
      },
      {
        img: "media/cards/death.png",
      ...
      12,
      32),
        text_def: ["So dad was thinking about quitting the grave digging business.",
      ...
      14),
        text_rev: [
          ...
          "I can\'t believe I have to help plan a funeral." // ACT 6
        ]
      },
      {
        img: "media/cards/justice.png",
      ...
      17,
      32),
        text_def: ["In between bong hits Asher told me about this geek that really pissed him off. Something about him stealing something important from him. I don\'t really get why it was so important to him. Probably has to do with that Crypt Keeper looking math teacher he spends so much time with.",
      ...
      14),
        text_rev: [
          ...
          "God that made me feel sick. This isn\'t me." // ACT 7
        ]
      },
      {
        img: "media/cards/moon.png",
      ...
      23,
      32),
        text_def: ["I got a text from Asher after class. It just said \"<i style=\"font-family: monospace\">IMPORTANT! MY HOUSE! RIGHT NOW!</i>\" He never texts first so that caught me by surprise. I thought he must have been into some wild shit, and boy was I right.",
      ...
      14),
        text_rev: [
          ...
          "I don\'t know what to think anymore. Administration brought us into the gym while the police were called. They said that Reuven replaced himself with a salt statue when no one was looking. There are 30 people in that class. How could no one notice?" // ACT 8
        ]
      },
      {
        img: "media/cards/world.png",
      ...
      14),
        text_rev: [
          ...
          "I guess there is one way to find out. Time to play the waiting game." // ACT 9
        ]
      },
      {
        img: "media/cards/wheel.png",
      ...
      17,
      32),
        text_def: ["So according to the demon I slayed, I am supposed to die on this day in 10 years.",
      ...
      21,
      14),
        text_rev: ["I told Asher and Cedrick about my death sentence from Demon-Rose.",
    ...
    for (k = 0, len = cards_asher.length; k < len; k++) {
      card = cards_asher[k];
      card.name = "asher";
      deck.push(new Card(card));
    }
    // load in cedrick's cards
    for (l = 0, len1 = cards_cedrick.length; l < len1; l++) {
      card = cards_cedrick[l];
      card.name = "cedrick";
      deck.push(new Card(card));
    }
    // load in gustave's cards
    for (m = 0, len2 = cards_gustave.length; m < len2; m++) {
      card = cards_gustave[m];
      card.name = "gustave";
      deck.push(new Card(card));
    }
    // tracking variables
    flipped = 0;
    to_flip = Math.floor(deck.length / 2);
  ...
  window.onload = function() {
    ...
    return $("#Draw").on('click', function() {
      ...
      return app.cloth.draw();
    });
  };

  Cloth = class Cloth {
    constructor(cloth, deck1) {
      var slot;
      this.cloth = cloth;
      this.deck = deck1;
      this.grave = [];
    ...
    async draw() {
      ...
      buffer.sort(function(a, b) {
        var date_a, date_b;
        date_a = a.reversed ? a.date_rev : a.date_def;
        date_b = b.reversed ? b.date_rev : b.date_def;
      ...
      for (l = 0, len1 = ref1.length; l < len1; l++) {
        ...
        slot.card = buffer.shift();
      }
      ref2 = this.hand;
      for (m = 0, len2 = ref2.length; m < len2; m++) {
        slot = ref2[m];
        // render each card in @hand
        slot.card.load($(slot.div));
      }
      return this.wipe();
    }
    ...
    wipe(dur = 1750) {
      this.wiping = true;
      return this.cloth.slideToggle(dur, () => {
        return this.wiping = false;
      });
    }

    recall() {
      var card;
      while (this.grave.length > 0) {
        card = this.grave.pop();
        if (card.fresh) {
          this.deck.push(card.recall());
        }
      }
  ...
  Card = (function() {
    ...
    class Card {
      constructor(card_opt) {
        this.reversed = false; // whether the card should be displayed reversed
        this.fresh = true; // whether the card has been shown before
        this.name = card_opt.name;
        this.img = card_opt.img;
        this.text_def = card_opt.text_def; // the default card text
        this.date_def = card_opt.date_def;
        this.text_rev = card_opt.text_rev; // the reversed card text
        this.date_rev = card_opt.date_rev;
      }

      load(target) {
        var date, k, len, p, sign, text, text_div;
        if (this.reversed) {
          text = this.text_rev;
          date = this.date_rev;
        ...
        target.find(".illu").attr("src", this.img);
        // set the nameplate image src
        return target.find(".name").attr("src", `media/names/${this.name}.png`);
      }
